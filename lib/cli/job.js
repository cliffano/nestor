 ...
 * Success job creation message will be displayed when there's no error.
 *
 ...
 * Job status and health reports will be displayed when there's no error.
 *
 * @param {Function} cb: callback for argument handling
 * @return Jenkins API handler function
 */
function read(cb) {
  return function (name, args) {
    function resultCb(result) {
      ...
      var status = util.statusByColor(_job.color);
      var color  = result.status || 'grey';
 ...
 * Success job update message will be displayed when there's no error.
 *
 * @param {Function} cb: callback for argument handling
 * @return Jenkins API handler function
 */
 ...
 * Success job deletion message will be displayed when there's no error.
 *
 * @param {Function} cb: callback for argument handling
 * @return Jenkins API handler function
 */
 ...
 * Success job enabled message will be displayed when there's no error.
 *
 * @param {Function} cb: callback for argument handling
 * @return Jenkins API handler function
 */
 ...
 * Success job disabled message will be displayed when there's no error.
 *
 * @param {Function} cb: callback for argument handling
 * @return Jenkins API handler function
 */
 ...
 * Success job copy message will be displayed when there's no error.
 *
 * @param {Function} cb: callback for argument handling
 * @return Jenkins API handler function
 */
 ...
 * Jenkins job config.xml will be displayed when there's no error.
 *
 * @param {Function} cb: callback for argument handling
 * @return Jenkins API handler function
 */

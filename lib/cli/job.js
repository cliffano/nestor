 ...
 */
function create(cb) {
  return function (command, name, configFile) {
...
function build(cb) {
  ...
  return function (command, name, paramsString) {
...
function _console(cb) {
  return function (command, name, buildNumber) {
 ...
 */
function copy(cb) {
  return function (command, existingName, newName) {
    function resultCb(result) {

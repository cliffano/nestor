...
/** internal
 * Jenkins#_request(method, url, handlers, cb)
 * - method (String):
 * - url (String): 
 * - handlers (Object):
 ...
 * Result is an array containing objects with status as the key and name as the value.
 **/
...
Jenkins.prototype.version = function (cb) {
  ...
  _request('head', this.url, { 200: _success }, cb);
};
